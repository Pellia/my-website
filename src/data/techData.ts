...
import { IoLogoReact, IoLogoJavascript, IoLogoCss3, IoLogoHtml5, IoLogoNodejs, IoLogoPython, IoLogoDocker, IoGitPullRequest, IoDocumentTextSharp } from "react-icons/io5";
...
import { RiCodeAiFill, RiTestTubeFill } from "react-icons/ri";
...
export const techdata: TechCategory[] = [
    ...
    },
    {
        ...
        data: [
            ...
            { id: 2, name: "Python", icon: IoLogoPython, color: "#3776AB", gradientColor: ["#3776AB", "#FFD43B"] },
    ...
    },
    {
        ...
        data: [
            ...
            { id: 4, name: "Clean Code", icon: RiCodeAiFill, color: "#3178C6" },
