    ...
    return (
        <section className="mt-24 space-y-8">
            ...
            <p className="font-inter-medium text-lg">
                ...
                soluta. Magni voluptatum soluta doloribus natus. Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni, expedita natus rerum laudantium minus doloribus alias quaerat corrupti
                iusto totam assumenda nihil eaque cum voluptatibus quidem perferendis blanditiis ratione consectetur.
            </p>
            <p className="font-inter-medium text-lg">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa aliquid labore harum necessitatibus nesciunt, consequuntur sint sequi dicta unde dolore cupiditate repellendus vitae eos
